...
const buscar = async () => {
    ...
    const url = `/examen_final/API/permisos/buscar?permiso_usuario=${permiso_usuario}&permiso_rol=${permiso_rol}`;
    const config = {
        method : 'GET'
    }
...
const guardar = async (evento) => {
    ...
    const url = '/examen_final/API/permisos/guardar';
...
const modificar = async () => {
    ...
    const body = new FormData(formulario)
    const url = '/examen_final/API/permisos/modificar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (e) => {
    ...
    if(await confirmacion('warning','¿Desea eliminar este registro?')){
        ...
        body.append('permiso_id', id)
        const url = '/examen_final/API/permisos/eliminar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method : 'POST',
...
const activar = async (e) => {
    ...
    if(await confirmacion('warning','¿Desea activar este usuario?')){
        ...
        const url = '/examen_final/API/permisos/activar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method : 'POST',
...
const desactivar = async (e) => {
    ...
    if(await confirmacion('warning','¿Desea desactivar este usuario?')){
        const body = new FormData()
        body.append('usu_id', id)
        const url = '/examen_final/API/permisos/desactivar';
        const headers = new Headers();
        headers.append("X-Requested-With","fetch");
        const config = {
            method : 'POST',
